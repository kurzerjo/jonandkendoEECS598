function [A, b, params, iterative] = flow_operator(images,uv)
...
lambda               = 80;   %5e-2;
  ...
  F     = make_imfilter_mat(L, sz, 'replicate');
  ...
  A     = [duu duv; duv dvv]/sigmaD2 - lambda*M/sigmaS2;  
  b     = lambda *M*uv(:)/sigmaS2 - [Itx(:); Ity(:)]/sigmaD2;
